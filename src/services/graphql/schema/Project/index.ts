...
import { getProjectPaidPlan } from "../../../../utils/stripe/get-project-paid-plan";
import { plans } from "../../../../utils/stripe/plans";
import { generateInvitationToken } from "../../../../utils/invitations/token";
  ...
  definition: (t) => {
    ...
    t.nullable.field("inviteToProject", {
      ...
      resolve: async (_, { projectId, email }, ctx) => {
        ...
        await ctx.services.sendgrid.sendEmail({
          email,
