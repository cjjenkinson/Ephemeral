...
class Storage extends cdk.Stack {
  constructor(app, id, { stage, serviceName }) {
    ...
    const userAssetsBucket = new s3.Bucket(this, 'UserAssetsBucket', {
      versioned: false,
      bucketName: `<PROJECT-NAME>-${stage}-${serviceName}-user-assets`,
    ...
    const audioUploadsBucket = new s3.Bucket(this, 'AudioBucket', {
      versioned: false,
      bucketName: `<PROJECT-NAME>-${stage}-${serviceName}-audio`,
      publicReadAccess: false,
      blockPublicAccess: s3.BlockPublicAccess.BLOCK_ALL,
